if (Sys.getenv("USER") == "vagrant") {
  ...
  base <- "/home/aiddata/Desktop/GitHub"
}


source(paste(base, "/geoML/geoML.R", sep=""))

full.dta <- read.csv(paste(base, "/geoML/GEF_MFA/GEF_LD_contrast.csv", sep=""))
...
out_path = paste(base, "/geoML/GEF_MFA/LD_MFA_Contrast/NDVI/", sep="")
